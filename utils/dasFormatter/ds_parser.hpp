...
# define DAS_YYTOKENTYPE
  enum das_yytokentype
  {
    ...
    DOUBLE = 450,                  /* "double constant"  */
    NAME = 451,                    /* "name"  */
    KEYWORD = 452,                 /* "keyword"  */
    TYPE_FUNCTION = 453,           /* "type function"  */
    BEGIN_STRING = 454,            /* "start of the string"  */
    STRING_CHARACTER = 455,        /* STRING_CHARACTER  */
    STRING_CHARACTER_ESC = 456,    /* STRING_CHARACTER_ESC  */
    END_STRING = 457,              /* "end of the string"  */
    BEGIN_STRING_EXPR = 458,       /* "{"  */
    END_STRING_EXPR = 459,         /* "}"  */
    END_OF_READ = 460,             /* "end of failed eader macro"  */
    SEMICOLON_CUR_CUR = 461,       /* ";}}"  */
    SEMICOLON_CUR_SQR = 462,       /* ";}]"  */
    SEMICOLON_SQR_SQR = 463,       /* ";]]"  */
    COMMA_SQR_SQR = 464,           /* ",]]"  */
    COMMA_CUR_SQR = 465,           /* ",}]"  */
    END_OF_EXPR = 466,             /* END_OF_EXPR  */
    EMPTY = 467,                   /* EMPTY  */
    UNARY_MINUS = 468,             /* UNARY_MINUS  */
    UNARY_PLUS = 469,              /* UNARY_PLUS  */
    PRE_INC = 470,                 /* PRE_INC  */
    PRE_DEC = 471,                 /* PRE_DEC  */
    POST_INC = 472,                /* POST_INC  */
    POST_DEC = 473,                /* POST_DEC  */
    DEREF = 474                    /* DEREF  */
  };
