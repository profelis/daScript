...
echo %INCLUDE%
cl /Feasjit.exe /DUSE_JIT -I %WINSINC% -I %WININC% -I %VSINC% -I jit jit\as_jit.cpp jit\virtual_asm_windows.cpp jit\virtual_asm_x86.cpp main.cpp -I sdk.2.31\angelscript\include -I sdk.2.31\add_on\ sdk.2.31\angelscript\source\*.cpp /EHsc /DAS_USE_STLNAMES=1 sdk.2.31\add_on\scriptstdstring\*.cpp sdk.2.31\add_on\scriptarray\*.cpp /Ox /Oy /DNDEBUG /DAS_NO_THREADS  /DAS_NO_ATOMIC /Gd /Oi /MD /O2 winmm.lib 
cl /Feas.exe main.cpp -I %WINSINC% -I %WININC% -I %VSINC% -I sdk\angelscript\include -I sdk\add_on\ sdk\angelscript\source\*.cpp /EHsc /DAS_USE_STLNAMES=1 sdk\add_on\scriptstdstring\*.cpp sdk\add_on\scriptarray\*.cpp /Ox /Oy /DNDEBUG /DAS_NO_THREADS /DAS_NO_ATOMIC /Gd /Oi /MD /O2 winmm.lib 
