...
#pragma warning(pop)
    ...
    // environment
        ...
        /*option*/ bool auto_inline_functions = true;              // heuristic best-effort inlining of plain calls and operator sites of small [inline]-shaped functions (default ON; silent declines; optimized builds only; disable_auto_inline overrides)
