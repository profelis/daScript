...
typedef enum das_bool_policy {
    ...
    DAS_POLICY_AUTO_INLINE_FUNCTIONS             // Heuristic best-effort inlining of plain calls and operator sites of small [inline]-shaped functions (default ON; silent declines; optimized builds only)
} das_bool_policy;
